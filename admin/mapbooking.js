...
function initialize(){
    ...
    center: new google.maps.LatLng(-0.9229092, 100.368527),
    zoom: 16,
  ...
  barbershop_dig = new google.maps.Data();
	barbershop_dig.loadGeoJson('act/barbershop.php?id='+id.value);
	barbershop_dig.setMap(map);
	barbershop_dig.setStyle({
		fillColor: 'red',
		strokeColor: 'red'
	});
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  barbershop_dig.addListener('addfeature', function(e) {
