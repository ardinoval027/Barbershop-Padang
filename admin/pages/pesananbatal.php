 ...
 <div class="col-sm-12"> 
    <section class="panel">
                    <div class="panel-body">
                        <a title="Pesanan" class="btn btn-compose" style ="background-color: #9e1134">Booking Batal</a>
                        <div class="box-body">
                      ...
                      <div class="form-group">
                       <table id="example1" class="table table-hover table-bordered table-striped">
                        ...
                        where barbershop.id='$id' and b.status='3'");
                        ...
                        <td><?php echo "$p";?></td>
                        <td><?php if($status=='3'){ echo "Batal";}?></td>
