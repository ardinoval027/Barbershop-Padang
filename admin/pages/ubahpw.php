 <div class="col-sm-12"> <!-- menampilkan form add event-->
				<section class="panel">
                    <div class="panel-body">
                        ...
                        <a class="btn btn-compose" style ="background-color: #9e1134">Change Password</a>
                        <div class="box-body"	>
                      ...
                      <div class="form-group">
                        ...
                        <form class="form-horizontal style-form" role="form" action="act/changepass.php" method="post">
                          ...
                          <button type="submit" class="btn btn-primary pull-right" style ="background-color: #9e1134" onclick="show1()">Change <i class="fa fa-floppy-o"></i></button>  
                      </form>
