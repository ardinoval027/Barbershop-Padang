 ...
 <div class="col-sm-12"> 
    <section class="panel">
                    <div class="panel-body">
                        <a title="Pesanan" class="btn btn-compose" style ="background-color: #9e1134">Booking Dikonfirmasi</a>
                        <div class="box-body">
                      ...
                      <div class="form-group">
                       <table id="example1" class="table table-hover table-bordered table-striped">
                        ...
                        where barbershop.id='$id' and b.status='2'");
                        ...
                        <td><?php echo "$p";?></td>
                        <td><?php if($status=='2'){ echo "Dikonfirmasi";}?></td>
                        <td><div class="btn-group">
                        <a href="?page=dtpsn&barber=<?php echo $id_barber;?>&tgl=<?php echo $tgl_booking;?>&jam=<?php echo $jam;?>" class="btn btn-sm btn-default" style ="background-color: #9e1134" title='Detail'><i class="fa fa-list"></i> Detail</a>
                        </div>
                        <div class="btn-group">
