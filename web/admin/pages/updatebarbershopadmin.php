<div class="col-sm-6"> <!-- menampilkan peta-->
    ...
    <section class="panel">
				...
				$id=$_GET['id'];
				$sql = pg_query("SELECT id, nama, kontak, alamat, ST_AsText(geom) as geom, image FROM barbershop where id='$id'");
				$data =  pg_fetch_array($sql);
			?>
                         <form role="form" action="act/updatebbsadmin.php" enctype="multipart/form-data" method="post">
