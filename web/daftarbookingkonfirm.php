               ...
               <section class="panel">
                    <div class="panel-body">
                       ...
                       <table id="example1" class="table table-hover table-bordered table-striped">
                        ...
                        <td> <?php if($status=='2'){ echo "Dikonfirmasi";} else if($status=='3'){ echo "Batal";} ?></td>
                        <td><div class="btn-group">
                        <a href="detailbooking1.php?barber=<?php echo $id_barber;?>&tgl=<?php echo $tgl_booking;?>&jam=<?php echo $jam;?>" class="btn btn-sm btn-default" style="background-color: #9e1134" title='Detail'><i class="fa fa-list"></i> Detail</a>
                        </div>
                        <div class="btn-group">
